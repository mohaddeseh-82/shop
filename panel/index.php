							...
							<div class="row gx-9 h-100">
								...
								<div class="col-sm-6">
									...
									<div class="d-flex flex-column h-100">
										...
										<div class="mb-6">
											<!--begin::Text-->
											<span class="fw-semibold text-gray-600 fs-6 mb-8 d-block">تصاویر کارتونی
												مسطح با رنگ‌های واضح و ترکیب نشده و خانم موی زیبای بنفش نامتقارن</span>
											<!--end::Text-->
											<!--begin::Stats-->
											<div class="d-flex">
												<!--begin::Stat-->
									...
									<tbody>
										<tr>
											...
											<td class="text-end pe-12">
												<span class="badge py-3 px-4 fs-7 badge-light-primary">در حال
													پردازش</span>
											</td>
											<td class="text-end pe-0">
