                            ...
                            <div data-kt-search-element="wrapper">
                                ...
                                <form data-kt-search-element="form" class="w-100 position-relative mb-3"
                                    ...
                                    <input type="text" class="search-input form-control form-control-flush ps-10"
                                        name="search" value="" placeholder="جستجو..." data-kt-search-element="input" />
                                    <!--end::Input-->
                                    <!--begin::Spinner-->
                                    <span
                                ...
                                <div class="mb-5" data-kt-search-element="main">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-325px">
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-primary fw-semibold">"صفحه فرود
                                                    طراح" لانچ</a>
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="mailto <?php echo $user['email']; ?>"
                                        class="fw-semibold text-muted text-hover-primary fs-7"><?php echo $user['email']; ?></a>
                                </div>
                                <!--end::کاربرname-->
                            </div>
                        </div>
