                            ...
                            <div class="tab-content rounded h-100 bg-light p-10">
                                ...
                                <div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <!--begin::آیتم-->
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-muted flex-grow-1">ماژول دارایی ، مالیه ،
                                                سرمایه گذاری</span>
                        ...
                        <form class="form" novalidate="novalidate" id="kt_modal_create_app_form">
                                            ...
                                            <label class="d-flex flex-stack mb-5 cursor-pointer">
                                                ...
                                                <span class="d-flex align-items-center me-2">
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        ...
                                                        <span class="fs-7 text-muted">ایجاد یک ساختار متن واضح فقط یک
                                                            سئو است</span>
                                                    </span>
                                                    <!--end:Info-->
                                                </span>
                                            ...
                                            <label class="d-flex flex-stack mb-5 cursor-pointer">
                                                ...
                                                <span class="d-flex align-items-center me-2">
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        ...
                                                        <span class="fs-7 text-muted">ایجاد یک ساختار متن روشن فقط یک
                                                            جنبه است</span>
                                                    </span>
                                                    <!--end:Info-->
                                                </span>
                                            ...
                                            <label class="d-flex flex-stack cursor-pointer">
                                                ...
                                                <span class="d-flex align-items-center me-2">
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        ...
                                                        <span class="fs-7 text-muted">ایجاد یک متن متن روشن برای نوشتن
                                                            متن</span>
                                                    </span>
                                                    <!--end:Info-->
                                                </span>
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="me-5">
                                            ...
                                            <div class="fs-7 fw-semibold text-muted">اگر به اطلاعات بیشتری نیاز دارید ،
                                                لطفا برنامه ریزی بودجه را بررسی کنید</div>
                                        </div>
                                        <!--end::Tags-->
                                        <!--begin::Switch-->
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <!--end::Heading-->
                                    <!--begin::توضیحات-->
                                    <div class="text-muted fw-semibold fs-3">برنامه خود را برای شروع پروژه خود ثبت کنید.
                                    </div>
                                    <!--end::توضیحات-->
                                    <!--begin::Illustration-->
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-6">
                                    ...
                                    <a href="#"
                                        ...
                                        بارانی
                                        <span class="badge badge-light fs-8 fw-semibold ms-2">شرکت دارایی، مالیه، سرمایه
                                            گذاری</span></a>
                                    <!--end::نام-->
                                    <!--begin::ایمیل-->
                        ...
                        <div data-kt-search-element="results" class="d-none">
                            ...
                            <div class="d-flex flex-center mt-15">
                                ...
                                <button type="submit" id="kt_modal_users_search_submit" class="btn btn-primary">کاربران
                                    انتخاب شده را اضافه کنید</button>
                            </div>
                            <!--end::Actions-->
                        </div>
                        <!--end::Results-->
