				...
				<br>
									...
									<div class="card-body pt-0">
										...
										<div class="mb-10 fv-row fv-plugins-icon-container">
											...
											<input type="text" name="product_name" class="form-control mb-2"
												placeholder="نام محصول" value=" <?php echo $title; ?> ">
											<!--end::Input-->
											<!--begin::توضیحات-->
										...
										<div>
											...
											<!--end::Tags-->
											<!--begin::or-->
											<textarea name="product_content" id="" cols="30"
												rows="10" class="form-control"><?php echo $content; ?></textarea>
											<!--end::or-->
											<!--begin::توضیحات-->
									...
									<div class="card-body pt-0">
										...
										<div class="mb-10 fv-row fv-plugins-icon-container">
											...
											<input type="text" name="product_price" class="form-control mb-2"
												placeholder="قیمت محصول" value=" <?php echo $price; ?>">
											<!--end::Input-->
											<!--begin::توضیحات-->
										...
										<div class="mb-10 fv-row fv-plugins-icon-container">
											...
											<input type="text" name="product_discount" class="form-control mb-2"
												placeholder="قیمت محصول" value=" <?php echo $discount_percent;?>">
											<!--end::Input-->
											<!--begin::توضیحات-->
					...
					<div class="d-flex justify-content-end">
						...
						<a href="../../demo1/dist/apps/ecommerce/catalog/products.html"
							id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
						<!--end::Button-->
